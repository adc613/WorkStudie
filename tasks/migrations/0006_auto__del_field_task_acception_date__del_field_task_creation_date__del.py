...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Task.acception_date'
        raise RuntimeError("Cannot reverse this migration. 'Task.acception_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Task.acception_date'
        db.add_column(u'tasks_task', 'acception_date',
                      self.gf('django.db.models.fields.DateTimeField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Task.creation_date'
        raise RuntimeError("Cannot reverse this migration. 'Task.creation_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Task.creation_date'
        db.add_column(u'tasks_task', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Task.completion_Date'
        raise RuntimeError("Cannot reverse this migration. 'Task.completion_Date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Task.completion_Date'
