...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Review'
        db.create_table(u'tasks_review', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rating', self.gf('tasks.models.IntegerRangeField')(name='rating')),
            ('comments', self.gf('django.db.models.fields.TextField')(max_length=1000, blank=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='review_creator', null=True, to=orm['users.User'])),
        ))
        db.send_create_signal(u'tasks', ['Review'])

        # Adding model 'Bid'
        db.create_table(u'tasks_bid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bid', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('bidder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'])),
            ('message', self.gf('django.db.models.fields.TextField')(max_length=140, blank=True)),
        ))
        db.send_create_signal(u'tasks', ['Bid'])

        # Adding model 'Task'
        db.create_table(u'tasks_task', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=75)),
            ('discription', self.gf('django.db.models.fields.TextField')(max_length=420)),
            ('suggested_price', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2, blank=True)),
            ('accepted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='task_creator', to=orm['users.User'])),
            ('worker', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='task_worker', null=True, to=orm['users.User'])),
            ('accepted_bid', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accepted_bid', null=True, to=orm['tasks.Bid'])),
            ('worker_review', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='task_worker_review', null=True, to=orm['tasks.Review'])),
            ('creator_review', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='task_create_review', null=True, to=orm['tasks.Review'])),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('acception_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('completion_Date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'tasks', ['Task'])

        # Adding M2M table for field bids on 'Task'
        m2m_table_name = db.shorten_name(u'tasks_task_bids')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('task', models.ForeignKey(orm[u'tasks.task'], null=False)),
            ('bid', models.ForeignKey(orm[u'tasks.bid'], null=False))
        ))
        db.create_unique(m2m_table_name, ['task_id', 'bid_id'])


    def backwards(self, orm):
        # Deleting model 'Review'
        db.delete_table(u'tasks_review')

        # Deleting model 'Bid'
        db.delete_table(u'tasks_bid')

        # Deleting model 'Task'
        db.delete_table(u'tasks_task')

        # Removing M2M table for field bids on 'Task'
        db.delete_table(db.shorten_name(u'tasks_task_bids'))
    ...
    models = {
        ...
        u'tasks.task': {
            ...
            'acception_date': ('django.db.models.fields.DateTimeField', [], {}),
