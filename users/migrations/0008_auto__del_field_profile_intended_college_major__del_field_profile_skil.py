...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.intended_college_major'
        db.delete_column(u'users_profile', 'intended_college_major')

        # Deleting field 'Profile.skills_discription'
        db.delete_column(u'users_profile', 'skills_discription')
        ...
        # Adding field 'Profile.intended_major'
        db.add_column(u'users_profile', 'intended_major',
                      self.gf('django.db.models.fields.CharField')(default='Life', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.intended_college_major'
        db.add_column(u'users_profile', 'intended_college_major',
                      self.gf('django.db.models.fields.CharField')(default='Life', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Profile.skills_discription'
        db.add_column(u'users_profile', 'skills_discription',
                      self.gf('django.db.models.fields.TextField')(default='', max_length='1000', blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Profile.intended_major'
        db.delete_column(u'users_profile', 'intended_major')
    ...
    models = {
        ...
        u'users.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intended_major': ('django.db.models.fields.CharField', [], {'default': "'Life'", 'max_length': '255', 'blank': 'True'}),
        ...
        u'users.user': {
            ...
            'email_notifictions': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'merchant_account_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
