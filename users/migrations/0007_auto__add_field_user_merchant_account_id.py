...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.merchant_account_id'
        db.add_column(u'users_user', 'merchant_account_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.merchant_account_id'
        db.delete_column(u'users_user', 'merchant_account_id')
