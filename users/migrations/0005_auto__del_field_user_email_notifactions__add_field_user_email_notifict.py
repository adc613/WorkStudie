...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.email_notifactions'
        db.delete_column(u'users_user', 'email_notifactions')

        # Adding field 'User.email_notifictions'
        db.add_column(u'users_user', 'email_notifictions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'User.email_notifactions'
        db.add_column(u'users_user', 'email_notifactions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'User.email_notifictions'
        db.delete_column(u'users_user', 'email_notifictions')
